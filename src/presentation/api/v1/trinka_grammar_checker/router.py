...
from src.presentation.api.v1.trinka_grammar_checker.dto import TrinkaCheckResultDTO
...
async def translate(
    ...
    try:
        ...
        return TrinkaCheckResultDTO.model_validate(grammar_checked_object.__dict__)
